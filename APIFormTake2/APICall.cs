...
public class APICall
    {
        ...
        /// <returns></returns>
        public string NewCall(string username, string key, string method, string resource, Dictionary<string, string> parameters, string reqBody, string filepath)
        {
            ...
            if (method == "GET")
            {
                ...
                System.IO.File.WriteAllText(filepath + "/fileTest" + timestamp + ".json", response.Content);
            }
            return response.StatusCode.ToString();
        }

        //Older methods.  Probably don't need them anymore, but I kept them here just in case.


        //public string /*async void*/ GetCall(string url, string username, string key)
        //{
        ...
        //}
        //public string PostCall(string tournName, string username, string key)
        //{
        ...
        //}
        //public string PutCall(string tournName, string tournDesc, string username, string key)
        //{
        //    client.Authenticator = new HttpBasicAuthenticator(username, key);
        ...
        //    return response.StatusCode.ToString();
        //}
        //public string DeleteCall(string tournName, string username, string key)
        //{
        //    client.Authenticator = new HttpBasicAuthenticator(username, key);
